...
try:
    ...
    a.AddWarning(u"При загрузке атрибутивных данных из лесоустроительного проекта возникли проблемы!")
...
try:
    ...
    a.AddWarning(u"При загрузке пространственных данных из лесоустроительного проекта возникли проблемы!")
...
try:
    ...
    a.AddWarning(u"При загрузке данных о мастерских участках и обходах из лесоустроительного проекта возникли проблемы!")
